...
class CloudBackup(with_metaclass(ABCMeta)):
    ...
    def _take_backup(self):
        ...
        This method must be called between pg_backup_start and pg_backup_stop.
        """
...
class CloudBackupSnapshot(CloudBackup):
    """
    A cloud storage upload client using disk snapshots.
    """
    ...
    def __init__(
        ...
        :param CloudInterface cloud_interface: The interface to use to
          upload the backup
        :parma SnapshotInterface snapshot_interface: The interface to use for
    ...
    def _add_stats_to_backup_info(self):
        ...
        This is currently a no-op for snapshot backups.
        """
