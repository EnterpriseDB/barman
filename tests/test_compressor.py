...
class TestCompressionManager(object):
    ...
    def test_get_compressor_custom(self):
        ...
        assert comp_manager.get_default_compressor().MAGIC == \
            b'\x28\xb5\x2f\xfd'
    ...
    def test_identify_compression(self, tmpdir):
        ...
        compression_bz2 = \
            comp_manager.identify_compression(bz2_tmp_file.strpath)
        ...
        # check custom compression method creation
        compression_zip = \
            comp_manager.identify_compression(zip_tmp_file.strpath)
