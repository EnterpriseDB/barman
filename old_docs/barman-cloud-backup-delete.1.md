% BARMAN-CLOUD-BACKUP-DELETE(1) Barman User manuals | Version 3.11.1
...
Extra options for the aws-s3 cloud provider:
  ...
  --aws-irsa
                        use iam role service account instead of aws profile (recommended if running from an eks pod)
